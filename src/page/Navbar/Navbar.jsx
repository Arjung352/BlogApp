...
function Navbar() {
  ...
  return (
    <>
      {/* Overlay Navbar */}
      <div
        className={`w-screen h-screen min-h-screen fixed top-0 left-0 overflow-y-hidden bg-black inset-0 flex flex-col justify-between transform transition-transform ${
