      ...
      <div className="w-4/5 flex flex-row-reverse font-worksans max-lg:flex-col">
        ...
        <div className=" font-semibold font-2xl mr-16 mt-8 font-Nato max-lg:mb-4 max-sm:mr-0">
          ...
          <p>
            ...
            responsive web applications. Skilled in FRONT-END technologies such
            as HTML, CSS, JavaScript, and ReactJS, as well as BACK-END
            technologies including Node.js, Firebase, PHP, Express.js, My-SQL
            and MongoDB. Comfortable working with frameworks and libraries like
            Bootstrap, Material-UI, and Tailwind CSS. Dedicated to continuous
